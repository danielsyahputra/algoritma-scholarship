...
> Seorang pemilik restoran ingin menebak ingin menebak berapa banyak
> penjualan yang akan dihasilkan di bulan depan oleh restorannya. Untuk
> itu mereka mengembangkan sebuah model dengan:
...
Multiple R-squared = - artinya Sales mampu menjelaskan - untuk variabel
Profit, sisanya dijelaskan oleh variabel lain yang tidak dimasukkan ke
dalam model
...
-   Residuals = Error
-   Intercept = ... artinya, ketika salesnya 0, maka profit = ...
-   Coef. Sales = ... arinya, ketika sales naik 1, maka berkontribusi
    sebanyak ... terhadap profit
...
Membuat model_pd (model yang memprediksi profit berdasarkan variabel
discount)
...
Berapakah nilai R-Squared yang terdapat dalam model? Interpretasikan!
